...
struct LetterService {
    static let letterShared = LetterService()
    
    // 쪽지를 주고 받은 사람들의 리스트 조회
    func letterPeopleList(completion: @escaping (NetworkResult<Any>) -> Void){
                        ...
                        if let status = response.response?.statusCode {
                            ...
                            case 200:
                                ...
                                do {
                                    ...
                                    let object = try decoder.decode(LetterResponseString.self, from: data)
